...
const EN: Dict = {
  ...
  'settings.inspectAutoSubmit': 'Send Inspect/Lasso prompt to CC automatically (off = just prepare text)',
...
const CS: Dict = {
  ...
  'settings.inspectAutoSubmit': 'Prompt z Inspectu/Lasa odeslat do CC hned (vypnuto = jen připravit text)',
  'settings.theme':             'Téma',
