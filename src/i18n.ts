...
const EN: Dict = {
  ...
  'hub.toast.invalidName': 'Invalid project name (allowed: A-Z a-z 0-9 _ - . space, 1–64 chars)',
...
const CS: Dict = {
  ...
  'hub.toast.invalidName': 'Neplatný název projektu (povoleno: A-Z a-z 0-9 _ - . mezera, 1–64 znaků)',
