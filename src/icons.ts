// ── Icon set (Lucide-inspired, 16×16 stroke, currentColor) ──
//
// Použití:
//   icon('terminal')         → SVG string (16px)
//   icon('save', { size: 14 })
//
// Všechny ikony: stroke="currentColor", stroke-width=2, fill=none, round caps.
// Barva = aktuální `color` rodiče (přes currentColor), takže ladí s textem.
...
const PATHS: Record<IconName, string> = {
  ...
  editor:   '<path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/>',
  ...
  tokens:   '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/>',
  ...
  split:    '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="12" y1="3" x2="12" y2="21"/>',
  ...
  inspect:  '<path d="M5 3a2 2 0 0 0-2 2"/><path d="M19 3a2 2 0 0 1 2 2"/><path d="M21 19a2 2 0 0 1-2 2"/><path d="M5 21a2 2 0 0 1-2-2"/><path d="M9 3h1"/><path d="M9 21h2"/><path d="M14 3h1"/><path d="M3 9v1"/><path d="M21 9v2"/><path d="M3 14v1"/><path d="M21 14v1"/>',
...
function icon(name: IconName, opts: IconOptions = {}): string {
  ...
  if (!path) return '';
  return `<svg class="lvi" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round">${path}</svg>`;
}

(window as any).icon = icon;
(window as any).LVI = { icon };
